...
ActiveRecord::Schema[8.1].define(version: 2026_09_05_141958) do
  ...
  create_table "carriere_simulations", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.index ["token"], name: "index_carriere_simulations_on_token", unique: true
    t.index ["user_id", "kind"], name: "index_carriere_simulations_on_user_id_and_kind"
    t.index ["user_id"], name: "index_carriere_simulations_on_user_id"
  end
  ...
  create_table "simulation_sessions", force: :cascade do |t|
    t.jsonb "absences", default: [], null: false
    ...
    t.string "profession", default: "iade", null: false
    t.decimal "quotite"
  ...
  add_foreign_key "carriere_simulations", "users"
